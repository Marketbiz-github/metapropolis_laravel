                     ...
                     <div class="card-body p-0">
                        <div class="d-flex align-items-center auth-content">
                           <div class="col-lg-7 align-self-center">
                              <div class="p-3">
                                 <h2 class="mb-4">Register Dropshipper</h2>
                                    ...
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" autofocus required name="nama" type="text" placeholder=" ">
                                             <label>Nama</label>
                                          </div>
                                       </div>
                                       <div class="col-lg-12">
                                       ...
                                       <div class="col-lg-12">
                                          <div class="floating-label form-group">
                                             <input class="floating-input form-control" required name="no_telp" type="number" placeholder=" ">
                           ...
                           <div class="col-lg-5 content-right">
                              <img src="{{('image_propolis/propolis2.jpg')}}" class="img-fluid image-right" alt="">
                           </div>
                        </div>
                     </div>
                  </div>
