...
<div class="container-fluid">
    ...
    <div class="col-lg-8">
        <form action="{{route('manfaat_admin.store')}}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="form-group">
                <label class="form-label" for="gambar_ikon">Ikon Manfaat</label>
                <img class="img-preview img-fluid mb-3 col-sm-5">
                <input type="file" required class="form-control" name="gambar_ikon" id="gambar_ikon" 
                onchange="previewImage()" />
            </div>
            <div class="form-group">
                <label class="form-label" for="gambar_manfaat">Gambar Manfaat</label>
                <img class="img-preview2 img-fluid mb-3 col-sm-5">
                <input type="file" required class="form-control" name="gambar_manfaat" id="gambar_manfaat" 
                onchange="previewImage2()" />
            </div>

            <div class="form-group">
                <label>Nama Manfaat</label>
                <input class="form-control" required name="nama_manfaat" id="nama_manfaat" placeholder="Nama Manfaat" value="{{old('nama_manfaat')}}" />
            </div>
            {{-- <div class="form-group">
                <b>Isi Blog</b>
